    ...
    <div className="p-4 md:p-0 lg:flex lg:flex-col lg:h-full">
      <div className="lg:flex lg:justify-center lg:gap-5 lg:flex-1 lg:min-h-0">
        ...
        <div className="lg:min-w-[55.5%] lg:max-w-[55.5%] lg:flex lg:flex-col">
          <div className="bg-white overflow-y-auto p-6 md:px-10 md:pt-12 md:pb-10 rounded-tr-xl rounded-tl-xl min-h-[627px] max-h-[627px] md:min-h-[780px] md:max-h-[780px] lg:min-h-0 lg:max-h-none lg:flex-1">
